! function(e) {
	e(["jquery"], function(e) {
		return function() {
			...
			function n(t, n) {
				return t || (t = g()), v = e("#" + t.containerId,window.top.document), v.length ? v : (n && (v = c(t)), v)
			}
			...
			function c(t) {
				v = e("<div/>").attr("id", t.containerId).addClass(t.positionClass).attr("aria-live", "polite").attr("role", "alert"), v.appendTo(e('body',window.top.document)), v
				return v;
			}
