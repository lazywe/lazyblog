$(function() {
	...
	function n() {
		var t = $(this).attr("href"),
		    did = $(this).attr("did"),
			a = $(this).data("index"),
			i = $.trim($(this).attr('title')),
			n = !0;
		if (void 0 == t || 0 == $.trim(t).length) return !1;
		var rt = ($(".J_menuTab").each(function() {
			return $(this).data("id") == did ? ($(this).hasClass("active") || ($(this).addClass("active").siblings(".J_menuTab").removeClass("active"), e(this), $(".J_mainContent .J_iframe").each(function() {
				return $(this).data("id") == did ? ($(this).show().siblings(".J_iframe").hide(), !1) : void 0
			})), n = !1, !1) : void 0
		}), n)
		if(!rt){
			$('#content-main iframe:visible')[0].contentWindow.location.reload();
		}else{
			var s = '<a href="javascript:;" class="active J_menuTab" data-id="' + did + '">' + i + ' <i class="fa fa-times-circle"></i></a>';
			$(".J_menuTab").removeClass("active");
			var r = '<iframe class="J_iframe"  name="iframe' + a + '" width="100%" height="100%" src="' + t + '"  id="' + did + '" frameborder="0" data-id="' + did + '" seamless></iframe>';
